...
class OrderBook:
    ...
    def _match(self, taker_order: Order, maker_book: SortedDict, is_bid: bool) -> List[Trade]:
        trades = []
        
        while taker_order.qty > 0 and maker_book:
            best_price = maker_book.peekitem(0)[0] if is_bid else maker_book.peekitem(-1)[0]
